// Revision
"use strict";
console.log("Lecture 29");
// Functions
// Functions Declarations
// Function قبل وبعد Access بنقدر هان نعمل
// d();
function d() {
...
function greet(name_1, name_2) {
  // NaN = undefind + undefind -> Parameter لما ما يكون
...
const arrowGreet = () => {
  ...
  // inhert outer this -> الي برا this بتورث ال
  console.log(this);
};
...
const user = {
  name: "maslma",
  [usernameKey]: "Engmaslma",
  settings,
};

user.email = "maslmaalzebda23@gmail.com";
...
// Cloning -> pointer بدل ما اعمل coping هان بنعمل
...
// nestedObject الى cloning ما بنقدر نعمل
//Object.assign بدل structuredClone عشان نحل قصتها بنستخدم
