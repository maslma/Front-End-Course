// Lecturer's explanation on the website (Java.info)
//(Array Methoud) استكمال لمحاضرة 33
// Array in javaScript -> Dequeue
const developers = [
  {
    id: 1,
    name: "Shawqi",
...
// forEach -> array وما بنقدر نعدل على array بتعمل لوب على كل عناصر الموجودة في
...
console.log("-------------------- filter() --------------------");
// بترجع هاد كل العناصر الموجودة
// filter() -> searching in arrays for multiple elements.
// filters all elements that match callback condition and returns them in an
// array.
...
console.log("-------------------- map() --------------------");
// array وتالت اشي بترجع  call back condtion اول اشي بتعمل لوب على كل عناصر وتاني اشي بتعدل على العناصر الي هيا
// map() -> transforming arrays.
// [...] -> [...]
// first it iterates over an array elements, modifies them base on callback
// condition, and returns a new modified/transformed array.
