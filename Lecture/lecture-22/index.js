...
// Function Expressions -> value بنستخدمها
...
// Callback Functions ->نانية بتستدعيها وقت ما تحتاجها Functions تانية على اساس  Functions بعطيها ل  Functions هي عبارة عن
...
// Function Declarations-> Functionهان بنقدر نستخدمها قبل وبعد
// Function Expressions-> بس ما بنقدر نستخدمها قبل Function هان بنقدر نستخدمها بعد
...
// Arrow Functions-> Expressions هي عبارة عن 
