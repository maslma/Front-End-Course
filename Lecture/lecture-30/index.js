...
let string = "Hello";
// 1- Use (useStrick)-> TypeError: Cannot create property 'number' on string 'Hello'
// 2- Not Use (useStrick)-> Undefined
// string.number = 8;
// console.log(string.number); 

console.log("-------- Numbers --------");
console.log(1_000_000_000); // Under Scor بنعمل الها Ignor 
...
// to understand "Imprecise Calculations" you must either watch the lecture or go to 
...
console.log(isFinite(input)); // false
