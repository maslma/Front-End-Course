...
// How to delete an element from the array the same way we used to do with
// objects.
let object = {
...
console.log("----------------- Removing `splice()` method ----------------");
...
// Replacing elements.
console.log("----------------- Replacing `splice()` method ----------------");
...
console.log(
  "----------------- Inserting to the beginning `splice()` method ----------------"
);
...
// array_2.length -> 6
// array_2.length - 1 -> 5
("----------------- Inserting to the end `splice()` method ----------------");
...
// Using `map()` method
console.log(
  "----------------- Transforming an Array|Using `map()` method  -------------"
);
