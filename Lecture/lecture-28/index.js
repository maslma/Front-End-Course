...
console.log("----------------- JavaScript Environments --------------");
// this بتختلف global function  لو كان
console.log(this);
...
// window -> browser اما موجودى في  node مش موجودة في
//   console.log(window);
...
console.log(window.x_1); // undefind
console.log(window.x_2); // undefind
...
// (if , while , do , etc...)-> (var)اما الي متاحة برا السكوب , (const , let)الي مش راح يكون متاح برا السكوب
...
// (varable function)-> function (const , let , var) مش راح يكون متاح برا
...
function executeSomethingElse() {
  // Cannot access 'b_2' before initialization
  // b_2 = "Modified b_2";
  // let b_2 = 200000;
  b_3 = "Modified b_3";
  var b_3 = 300000;
