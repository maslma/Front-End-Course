...
const greet = function () {
  console.log(
    `AsSalam Alaikum. I am ${this.name} and I have been born on ${this.dob}. So,
...
// areow function -> this عشان ما الها  Constructor ما الها
// another example
function cart() {
  // this = {}
...
console.log("---------------- Constructor Mode Test -----------------");

function Customer(name, username, email) {
  //الي احنا معرفينوا Constructor وبسير نفس  new هان في حال ما ساتخدمنا او نسينى نكتب
  if (!new.target) {
...
// 1- Error بطلع StrickMode هان في ال
// 2- Window برجع return this في حال Window بطلع NonStrickMode اما
...
// console.log(anotherSubscription.payment.method?.type); // anotherSubscription.payment is undefined
// console.log(anotherSubscription.payment.method); // anotherSubscription.payment is undefined
...
console.log(anotherSubscription.payment); // undefind -> بتفحص دالة اذا موجودة او لاء
console.log(anotherSubscription.payment?.method); // undefind -> بتفحص دالة اذا موجودة او لاء
console.log(anotherSubscription.payment?.method?.type); // undefind -> بتفحص دالة اذا موجودة او لاء
